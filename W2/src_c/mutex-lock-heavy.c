...
#define NUM_TRANS 1000  // Tăng lên 1000 để so sánh với without-lock-heavy
...
int main(int argc, char * argv[]){
    ...
    printf("=== BANK SIMULATION WITH MUTEX LOCKING (Heavy) ===\n");
    ...
    if(difference == 0) {
        printf("✅ CONSISTENT - Perfect thread synchronization with mutex!\n");
    } else {
        printf("❌ INCONSISTENT - Mutex failed unexpectedly!\n");
    }
